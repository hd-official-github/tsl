...
<div class="wrapper-content wrapper-content--ud" infinite-scroll="">
   <div class="container-fluid" style='width:100%; margin-top:-29px;'>
      <div class="row">
         <div class="col-sm-7 first-img">
            <img src="<?php echo base_url() . 'assets/images/b1.jpeg' ?>" alt="" style='height:100%; width:100%'>
         </div>

         <div class="col-sm-5 sec-img">
            <img src="<?php echo base_url() . 'assets/images/b1.jpeg' ?>" alt="" style='height:200px; width:100%'>
            <div class="row mt-3">
               <div class="col-sm-6 th-img"><img src="<?php echo base_url() . 'assets/images/b1.jpeg' ?>" alt="" style='height:250px; width:100%'></div>
               <div class="col-sm-6 forth-img"><img src="<?php echo base_url() . 'assets/images/b1.jpeg' ?>" alt="" style='height:250px; width:100%'></div>
            </div>
         </div>
      </div>
   </div>
   <div class="wrapper main-cont">
      ...
      <div class="container mt-5 p-0 align-center" style="margin-bottom:-224px;">
         <div class="row">
      ...
      <!-- ///location?/ -->
      <div class="container" style='margin-top:50px; margin-left:-12px;'>
         <div class="row">

         </div>
         <div class="row p-0">
            <div class="col-sm-8 mt-3" style='height:auto; width:755px;'>
               <div class="container bg-white" style='border-radius:5px; box-shadow:0 0 16px rgb(0 0 0 / 4%)'>
                  <div class="mapouter">
                     <div class="multi-line-header multi-line-header--centered">
                        <div class="" style='letter-spacing:1px; text-align:left; margin-left:10px; font-size:25px; font-weight:700'>
                           LOCATION
            ...
            <div class="col-sm-8 mt-3" style='width:755px;'>
               <div class="container bg-white setheight" style='border-radius:5px; height:auto; box-shadow:0 0 16px rgb(0 0 0 / 4%)'>
                  <div class='row p-4'>
                     <div class="multi-line-header multi-line-header--centered">
                        <div class="" style='letter-spacing:1px; text-align:left; margin-left:10px; font-size:25px; font-weight:700'>
                           CONTACT US
