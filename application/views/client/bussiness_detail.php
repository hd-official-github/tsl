      ...
      <div class="row" style='max-height:500px;'>
         ...
         if ($c == 1) { ?>
            <div class="col-sm-12 first-img" style='max-height:500px'>
               <img src="<?php foreach ($image->result() as $row) {
                              echo $row->image_url;
                              break;
         ...
         <?php } else if ($c == 0) { ?>
            ...
            <div class="col-sm-12 first-img" style='max-height:500px'>
               <img src="<?php foreach ($details->result() as $row) {
                              echo $row->main_image;
                              break;
                           } ?>" alt="" style='height:100%; width:100%'>
            </div>
         ...
         <?php } else if ($c == 3) { ?>
            ...
            <div class="col-sm-4 sec-img" style="max-height: 250px;">
               ...
               <div class="row mt-4" style="max-height: 250px;">
                  <div class="col-sm-12 th-img" style="max-height: 250px;"><img src="<?php $a = 0;
                     foreach ($image->result() as $row) {
                       if ($a == 2) {
                         echo $row->image_url;
                            break;
            ...
            <?php } else if ($c == 4) { ?>
               ...
               <div class="col-sm-4 sec-img" style="max-height: 250px;">
                  ...
                  <div class="row mt-4" style="max-height: 250px;">
                     <div class="col-sm-6 th-img" style="max-height: 250px;"><img src="<?php $b = 0;
                        foreach ($image->result() as $row) {
                           if ($b == 2) {
                              echo $row->image_url;
                              break;
                        ...
                        <div class="col-sm-6 forth-img" style="max-height: 250px;"><img src="<?php $c = 0;
                  foreach ($image->result() as $row) {
                     if ($c == 3) {
                        echo $row->image_url;
                        break;
