      ...
      <div class="container">
         ...
         <div class="container lshead">
            <div class="row mt-5">
               ...
               <div class="col-sm-8 listheading">Best <?php if(isset($subcategory)){foreach($subcategory->result() as $row){ echo $row->sub_category; break; }} else { echo "Spa"; }?> in <span><?php if(isset($subloc)){
                  echo $subloc;  } else echo $this->uri->segment(1);?></span></div>
            </div>
         </div>
         <div class="bg-white p-3 chead secondhead" style='margin-top:-20px; width:100%;'>
            <div class='row'>
               <div class="col-sm-12">
                  ...
                  <h3 style="position:relative; left:29px; top:17px">Best <?php if(isset($subcategory)){foreach($subcategory->result() as $row){ echo $row->sub_category; break; }} else { echo "Spa"; }?> in <?php if(isset($subloc)){
                     echo $subloc;  }else echo $this->uri->segment(1); ?></h3>
               </div>
            </div>
         </div>
         <!-- /////the bottom row  -->
