                ...
                <div id="mobile-nav-drop" class="">
                    <ul class="mobile-tool-list">
                        ...
                        <li><a href="/go-to-gift-page" class="gift-link main-header-link">
                                ...
                                <span class="text" style='background:#f07c7c; padding:9px; border-radius:5px;  color:white; box-shadow:0px 0px 8px black; display:flex; padding-right:9px; align-items:center;'><i class="far fa-plus-square fa-2x" style="padding-right:10px; text-align:center;"> </i> New Bussiness</span>
                            </a>
                        </li>
                        <li class="divider desktop-hidden"></li>
                        ...
                        <merchant-list-card pagetype="listing">
                           <a class="card-main onvisit card-main--equal-height cursor-pointer text-decoration-none" same-height="" href="bang_details">
                              <div class="card-main__content card-main__content--lg">
                                 <div class="">
                                    <div class="fl-column position-relative">
                                       <img class="card-main__img img-responsive" src="https://img4.nbstatic.in/tr:w-350/602f96bd00106d000bda7e2f.jpg" style="max-height: 155px; border-radius: 3px;" data-lzled="true">
                                       <!---->
                                       <merchant-rating>
                                          <!---->
                                          <div class="margin-right-s card-rating__listing">
                                             <div class="card-rating margin-bottom-zero nb--4-5">
                                                ...
                                                <!----><span class="card-rating__value font-weight-bold line-height-default">4.3</span>
                                             </div>
                                          </div>
                                          <!---->
                                       </merchant-rating>
                                    ...
                                    <div class="fl-column">
                                       ...
                                       <h2 class="card-main__heading margin-top-s ">
                                          Qi Spa - Aloft New Delhi Aerocity
                                          <!---->
                                    ...
                                    <div class="card-main cm">
                                       <div class="fl-row fl-row--middle fl-row--start margin-bottom-xs">
                                          ...
                                          <p class="card-main__value txt-primary line-height-primary font-weight-semibold">
                                             Massage Offer
                                             from
                                             <i class="fas fa-rupee-sign rupee"></i>1999
                                          </p>
                                       </div>
                                       <!---->
                                    </div>
                              ...
                              <div class="card-main__footer">
                                 <div class="section content-footer border-radius--bottom">
                                    <div class="fl-row fl-row--middle">
                                       <div class="fl-column">
                                          <p class="card-main__field line-height-xs font-weight-semibold txt-secondary bought-co;unt">140 Bought</p>
                                       </div>
                                       <div class="fl-column">
                                       </div>
                                    </div>
                           ...
                           <a class="card-main onvisit card-main--equal-height cursor-pointer text-decoration-none" same-height="" href="/delhi-ncr/qi-by-zivaya-spa-hotel-aloft-aerocity-aerocity?merchantId=265556">
                                    ...
                                    <div class="card-main cm">
                                       <div class="fl-row fl-row--middle fl-row--start margin-bottom-xs">
                                          ...
                                          <p class="card-main__value txt-primary line-height-primary font-weight-semibold">
                                             Massage Offer
                                             from
                                             <i class="fas fa-rupee-sign rupee"></i></i>1999
                                          </p>
                                       </div>
                                       <!---->
                                    </div>
                              ...
                              <div class="card-main__footer">
                                 <div class="section content-footer border-radius--bottom">
                                    <div class="fl-row fl-row--middle">
                                       <div class="fl-column">
                                          <p class="card-main__field line-height-xs font-weight-semibold txt-secondary bought-count">140 Bought</p>
                                       </div>
                                       <div class="fl-column">
                                       </div>
                                    </div>
                                 ...
                                 <div class="">
                                    <div class="fl-column position-relative">
                                       ...
                                       <merchant-rating>
                                          <!---->
                                          <div class="margin-right-s card-rating__listing">
                                             <div class="card-rating margin-bottom-zero nb--4-0">
                                                <!----><img alt="nb" class="card-rating__nb" height="10" src="<?php echo base_url().'assets/images/sl_icon.png'; ?>"  data-lzled="true">
                                                <!---->
                                                <span class="card-rating__img"></span>
                                                <!----><span class="card-rating__value font-weight-bold line-height-default">3.8</span>
                                             </div>
                                          </div>
                                          <!---->
                                       </merchant-rating>
                                        ...
                                        <div class="card-main__content card-main__content--lg">
                                            ...
                                            <div class="">
                                                <div class="fl-column position-relative">
                                                    <img class="card-main__img img-responsive" src="https://img4.nbstatic.in/tr:w-350/602f96bd00106d000bda7e2f.jpg" style="max-height: 155px; border-radius: 3px;" data-lzled="true">
                                                    <!---->
                                                    <merchant-rating><!----><div class="margin-right-s card-rating__listing">
    <div class="card-rating margin-bottom-zero nb--4-0">
        <!----><img alt="nb" class="card-rating__nb" height="10" src="<?php echo base_url().'assets/images/sl_icon.png'; ?>"  data-lzled="true">
        <!---->
        <span class="card-rating__img"></span>
