        ...
        <div id="wrapper" class="wrapper">
            ...
            <div class="banner-section-container">
                                ...
                                <div class="row align-items-end no-gutters" style='margin:10px;'>
                                    <div class="col-xl-6 mb-4 mb-xl-0 py-3 px-4 bg-white border-right position-relative rounded-left form-search-item">
                                        ...
                                        <div class="input-group dropdown show" onclick="dropwhat()">
                                            <input type="text" autocomplete="off" id="key-word" name="key-word" class="form-control border-0 px-0 bg-transparent" placeholder="Ex: food, service, barber, hotel" data-toggle="dropdown" aria-haspopup="true" aria-expanded="ture" style='box-shadow:none;'>
                                            ...
                                            <ul class="dropdown-menu form-search-ajax ulclsw" aria-labelledby="key-word" x-placement='top-start' style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(20px, -205px, 0px);">
                                                <li class="dropdown-item item">
                                                    <a href="#" class="text-decoration-none">
                                                        ...
                                                        <span class="lisize">Spa</span>
                                                    </a>
                                                </li>
                                                <li class="dropdown-item item">
                                                    <a href="#" class="link-hover-dark-white text-decoration-none">
                                                        
                                                        <span class="lisize">Massage</span>
                                                    </a>
                                                </li>
                                    ...
                                    <div class="col-xl-4 mb-4 mb-xl-0 py-3 px-4 bg-white position-relative rounded-right form-search-item">
                                        ...
                                        <div class="input-group dropdown show" onclick="drop()">
                                            <input type="text" autocomplete="off" id="region" name="region" class="form-control form-control-mini border-0 px-0 bg-transparent" placeholder="San Francisco" data-toggle="dropdown"  aria-haspopup="true" style='box-shadow:none;'>
                                            <a href="#" class="input-group-append text-decoration-none" data-toggle="dropdown">
                                            <i class="fas fa-chevron-down"></i>
                                            </a>
                                            <ul class="dropdown-menu form-search-ajax ulcls" aria-labelledby="key-word" x-placement='top-start' style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(20px, -205px, 0px);">
                                                <li class="dropdown-item item">
                                                    <a href="#" class="link-hover-dark-white lisize text-decoration-none" >
                                                        Austin
                                                    </a>
                                                </li>
                                                <li class="dropdown-item item">
                ...
                <div class="col-sm-12 bg-white" style='margin:0px; padding:15px; border-bottom:1px solid grey;'>
                    ...
                    <div class='secondary_navbar mx-5'> 
                    
                            <div class='secondary-icon'>
                            <a href="" class='text-decorate'>
                                <img src="<?php echo base_url().'assets/images/f.png'; ?>" alt="icon"  class='image-icon'>
                                <p class='pag'>Paraffin body wrap</p>
                                </a>
                            </div>
                    ...
                    <div class='secondary_navbar mx-5'> 
                            ...
                            <div class='secondary-icon'>
                            <a href="" class='text-decorate'>
                                <img src="<?php echo base_url().'assets/images/c.png'; ?>" alt="icon" class='image-icon'>
                                <p class='pag'>Full Body Massage</p>
                                </a>
                            </div>
                    ...
                    <div class='secondary_navbar mx-5'> 
                            ...
                            <div class='secondary-icon'>
                            <a href="" class='text-decorate'>
                                <img src="<?php echo base_url().'assets/images/herbal.png'; ?>" alt="icon" class='image-icon'>
                                <p class='pag'>Ayurvedic message</p>
                                </a>
                            </div>
                    ...
                    <div class='secondary_navbar mx-5'> 
                            ...
                            <div class='secondary-icon'>
                            <a href="" class='text-decorate'>
                                <img src="<?php echo base_url().'assets/images/e.png'; ?>" alt="icon" class='image-icon'>
                                <p class='pag'>Spot Treatment</p>
                                </a>
                            </div>
